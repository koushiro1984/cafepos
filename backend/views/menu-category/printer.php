...
$this->title = 'Menu Category Printer';
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        echo '&nbsp;&nbsp;&nbsp;';
                                        echo Html::a('<i class="fa fa-rotate-left"></i>&nbsp;&nbsp;&nbsp;Cancel', ['file', 'id' => $model->id], ['class' => 'btn btn-default']); ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="box box-danger">
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <?= GridView::widget([
                        ...
                        'toolbar' => [
                            [
                                'content' => Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['printer', 'id' => $model->id, 'pid' => $pid], [
                                            'data-pjax'=>false, 
                                            'class' => 'btn btn-success', 
                                            'data-placement' => 'top',
                                            'data-toggle' => 'tooltip',
