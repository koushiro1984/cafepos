        ...
        <table class="table">
            <thead>
                <tr style="border:1px solid">
                    ...
                    <th style="width: 150px">Gudang <?= $type == 'outflow-indelivery' ? 'Asal' : ($type == 'inflow-inreceive' ? 'Tujuan' : '') ?></th>
            ...
            <tbody>
                ...
                foreach ($modelStock as $dataStock): 
                    ...
                    <tr>
                        ...
                        <td class="line"><?= '(' . $dataStock[$storage]['id'] . ') ' . $dataStock[$storage]['nama_storage'] ?></td>
