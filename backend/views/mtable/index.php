...
$this->params['titleH1'] = '&nbsp;&nbsp;&nbsp;' 
        ...
        . '&nbsp;&nbsp;&nbsp;'
        . Html::a('<i class="fa fa-tags"></i>&nbsp;&nbsp;&nbsp;' . 'Category', ['mtable-category/index'], ['class' => 'btn btn-primary'])
        . '&nbsp;&nbsp;&nbsp;'
        . Html::a('<i class="fa fa-map"></i>&nbsp;&nbsp;&nbsp;' . 'Table Layout', ['mtable/table-layout'], ['class' => 'btn btn-primary']);
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'status',
                'format' => 'raw',
                'filter' =>  ['bebas' => 'Bebas', 'rusak' => 'Rusak'],
