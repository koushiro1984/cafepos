...
/* @var $searchModel backend\models\search\MenuDiscountSearch */
...
<div class="menu-discount-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'discount_type',
            [
                'attribute' => 'jumlah_discount',
                'value' => function ($model, $index, $widget) {
                    if ($model->discount_type === 'percent')
                        return Yii::$app->formatter->asDecimal($model->jumlah_discount) . ' %';
                    elseif ($model->discount_type === 'value')
                        return Yii::$app->formatter->asCurrency($model->jumlah_discount);
                },
            ],
            // 'start_date',
            // 'end_date',
