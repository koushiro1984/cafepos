            ...
            <div class="box-body">
                <div class="employee-form">                
                    ...
                    <?= $form->field($model, 'kd_karyawan', [
                        ...
                        ])->textInput(['maxlength' => 25, $model->isNewRecord ? '' : 'readonly' => $model->isNewRecord ? '' : 'readonly']) ?>
                    ...
                    <?= $form->field($model, 'image')->widget(FileInput::classname(), [
                            ...
                            'pluginOptions' => [
                                'initialPreview' => [
                                    Html::img(Yii::$app->request->baseUrl . '/img/employee/' . $model->image, ['class'=>'file-preview-image']),
                                ],
                                'showRemove' => false,
                                'showUpload' => false,
                            ]
