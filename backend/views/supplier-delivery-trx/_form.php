...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="box box-danger">
            <div class="box-body">
                <div class="supplier-delivery-trx-form">
                    ...
                    <?= $form->field($model, 'supplier_delivery_id')->textInput(['maxlength' => 13]) ?>

    <?= $form->field($model, 'purchase_order_id')->textInput(['maxlength' => 13]) ?>
    ...
    <?= $form->field($model, 'jumlah_terima')->textInput() ?>
