...
use backend\models\search\MenuReceiptSearch;
...
/**
 * MenuReceiptController implements the CRUD actions for MenuReceipt model.
 */
class MenuReceiptController extends BaseController
{
    ...
    /**
     * Lists all MenuReceipt models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MenuReceiptSearch();
    ...
    /**
     * Displays a single MenuReceipt model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MenuReceipt model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MenuReceipt();
    ...
    /**
     * Updates an existing MenuReceipt model.
    ...
    /**
     * Deletes an existing MenuReceipt model.
    ...
    /**
     * Finds the MenuReceipt model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return MenuReceipt the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MenuReceipt::findOne($id)) !== null) {
            return $model;
        } else {
