...
use backend\models\search\MenuDiscountSearch;
...
/**
 * MenuDiscountController implements the CRUD actions for MenuDiscount model.
 */
class MenuDiscountController extends BaseController
{
    ...
    /**
     * Lists all MenuDiscount models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MenuDiscountSearch();
    ...
    /**
     * Displays a single MenuDiscount model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MenuDiscount model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MenuDiscount();
    ...
    /**
     * Updates an existing MenuDiscount model.
    ...
    /**
     * Deletes an existing MenuDiscount model.
    ...
    /**
     * Finds the MenuDiscount model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return MenuDiscount the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MenuDiscount::findOne($id)) !== null) {
            return $model;
        } else {
