...
use backend\models\search\DirectPurchaseTrxSearch;
...
/**
 * DirectPurchaseTrxController implements the CRUD actions for DirectPurchaseTrx model.
 */
class DirectPurchaseTrxController extends BaseController
{
    ...
    /**
     * Lists all DirectPurchaseTrx models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DirectPurchaseTrxSearch();
    ...
    /**
     * Displays a single DirectPurchaseTrx model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DirectPurchaseTrx model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new DirectPurchaseTrx();
    ...
    /**
     * Updates an existing DirectPurchaseTrx model.
    ...
    /**
     * Deletes an existing DirectPurchaseTrx model.
    ...
    /**
     * Finds the DirectPurchaseTrx model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return DirectPurchaseTrx the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DirectPurchaseTrx::findOne($id)) !== null) {
            return $model;
        } else {
