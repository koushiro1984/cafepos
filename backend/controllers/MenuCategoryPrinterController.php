...
/**
 * MenuCategoryPrinterController implements the CRUD actions for MenuCategoryPrinter model.
 */
class MenuCategoryPrinterController extends BaseController
{
    ...
    /**
     * Lists all MenuCategoryPrinter models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MenuCategoryPrinterSearch();
    ...
    /**
     * Displays a single MenuCategoryPrinter model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MenuCategoryPrinter model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MenuCategoryPrinter();
    ...
    /**
     * Updates an existing MenuCategoryPrinter model.
    ...
    /**
     * Deletes an existing MenuCategoryPrinter model.
    ...
    /**
     * Finds the MenuCategoryPrinter model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return MenuCategoryPrinter the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MenuCategoryPrinter::findOne($id)) !== null) {
            return $model;
        } else {
