...
use backend\models\search\KodeTransaksiSearch;
...
/**
 * KodeTransaksiController implements the CRUD actions for KodeTransaksi model.
 */
class KodeTransaksiController extends BaseController
{
    ...
    /**
     * Lists all KodeTransaksi models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KodeTransaksiSearch();
    ...
    /**
     * Displays a single KodeTransaksi model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new KodeTransaksi model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new KodeTransaksi();
    ...
    /**
     * Updates an existing KodeTransaksi model.
    ...
    /**
     * Deletes an existing KodeTransaksi model.
    ...
    /**
     * Finds the KodeTransaksi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return KodeTransaksi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = KodeTransaksi::findOne($id)) !== null) {
            return $model;
        } else {
