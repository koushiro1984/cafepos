...
use backend\models\search\VotingSearch;
...
class VotingController extends BaseController
{
    ...
    /**
     * Updates an existing Voting model.
    ...
    /**
     * Display of Voting display which contain grafik.
     * @return mixed
     */
    public function actionDisplay() {
        ...
        return $this->render('display', [
            'models' => $models,
            'point' => $point,
            'count' => number_format(count($models), 0, '.', ','),
            'groupRate' => $groupRate,
        ]);
    }
