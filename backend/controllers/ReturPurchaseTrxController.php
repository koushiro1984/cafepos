...
use backend\models\search\ReturPurchaseTrxSearch;
...
/**
 * ReturPurchaseTrxController implements the CRUD actions for ReturPurchaseTrx model.
 */
class ReturPurchaseTrxController extends BaseController
{
    ...
    /**
     * Lists all ReturPurchaseTrx models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ReturPurchaseTrxSearch();
    ...
    /**
     * Displays a single ReturPurchaseTrx model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ReturPurchaseTrx model.
     * If creation is successful, the browser will be redirected to the 'update' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ReturPurchaseTrx();
    ...
    /**
     * Updates an existing ReturPurchaseTrx model.
    ...
    /**
     * Deletes an existing ReturPurchaseTrx model.
    ...
    /**
     * Finds the ReturPurchaseTrx model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return ReturPurchaseTrx the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ReturPurchaseTrx::findOne($id)) !== null) {
            return $model;
        } else {
