...
/**
 * DirectPurchaseTrxSearch represents the model behind the search form about `backend\models\DirectPurchaseTrx`.
 */
class DirectPurchaseTrxSearch extends DirectPurchaseTrx
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['direct_purchase_id', 'item_id', 'item_sku_id', 'storage_id', 'keterangan', 'created_at', 'user_created', 'updated_at', 'user_updated'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'direct_purchase_id', $this->direct_purchase_id])
