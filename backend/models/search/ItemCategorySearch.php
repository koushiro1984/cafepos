...
class ItemCategorySearch extends ItemCategory
{
    ...
    /**
     * Find Sub Item Category based on parent_category_id
     * 
     * @param array $parent_category_id
     * 
     * @return ActiveQuery
     */
    public static function getSubItemCategory($parent_category_id)
    {
        $query = ItemCategory::find()->where(['parent_category_id' => $parent_category_id]);
        return $query;
    }
}
