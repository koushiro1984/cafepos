...
/**
 * PurchaseOrderTrxSearch represents the model behind the search form about `backend\models\PurchaseOrderTrx`.
 */
class PurchaseOrderTrxSearch extends PurchaseOrderTrx
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['purchase_order_id', 'item_id', 'item_sku_id', 'keterangan', 'created_at', 'user_created', 'updated_at', 'user_updated'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'purchase_order_id', $this->purchase_order_id])
