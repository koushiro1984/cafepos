            ...
            <a href="<?= Yii::$app->urlManager->createUrl(['page/index', 'cid' => $mtable['id']]) ?>">
                <div class="col-lg-3 col-md-4 col-sm-4 mb">
                    <div class="darkblue-panel">
                        ...
                        <div class="row" style="padding: 0 15px; height: 150px; background: url('<?= Yii::getAlias('@backend-web') . '/img/mtable-category/thumb120x120' . $mtable['image'] ?>') no-repeat center">                                  
