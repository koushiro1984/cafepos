                ...
                <div style="padding: 0 10px 15px 10px">
                    <div class="row goleft">
                        <div class="col-md-12 col-sm-12 btnMenu">
                            <button id="btnCatatanMenu" class="btn btn-primary" type="button"><i class="ion ion-ios-list-outline" style="font-size: 16px; color: white"></i> Catatan Menu</button>                            
                            <a id="btnCashdrawer" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/open-cashdrawer']) ?>"><i class="ion ion-eject" style="font-size: 16px; color: white"></i> Cashdrawer</a>
                            <button id="btnPrintOrder" class="btn btn-primary" type="button"><i class="ion ion-compose" style="font-size: 16px; color: white"></i> Cetak Pesan</button>
                            <button id="btnPrintInvoice" class="btn btn-primary" type="button"><i class="ion ion-ios-printer" style="font-size: 16px; color: white"></i> Cetak Tagihan</button>
                            <button id="btnAntrianMenu" class="btn btn-primary" type="button"><i class="ion ion-ios-paper-outline" style="font-size: 16px; color: white"></i> Antrian Menu</button>
                            <button id="btnJumlahTamu" class="btn btn-primary" type="button"><i class="ion ion-ios-people" style="font-size: 16px; color: white"></i> Jumlah Tamu</button>
                            <button id="btnCloseTable" class="btn btn-danger" type="button"><i class="ion ion-ios-upload" style="font-size: 16px; color: white"></i> Close Table</button>
                        </div>                                                   
                    </div>
                    
                    <div class="row goleft" style="margin-top: 10px">
                        <div class="col-md-12 col-sm-12 btnMenu">
                            <a id="btnVoid" class="btn btn-danger" href="<?= Yii::$app->urlManager->createUrl(['page/void-menu']) ?>"><i class="ion ion-backspace" style="font-size: 16px; color: white"></i> Void Menu</a>
                            <a id="btnDiscount" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/discount']) ?>"><i class="ion ion-ios-pricetags" style="font-size: 16px; color: white"></i> Discount Menu</a>
                            <button id="btnSplit" class="btn btn-primary" type="button"><i class="ion ion-android-done-all" style="font-size: 16px; color: white"></i> Split</button>
                            <a id="btnTransMeja" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/get-mtable']) ?>"><i class="ion ion-arrow-return-right" style="font-size: 16px; color: white"></i> Transfer Meja</a>
                            <a id="btnTransMenu" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/get-mtable']) ?>"><i class="ion ion-arrow-swap" style="font-size: 16px; color: white"></i> Transfer Menu</a>
                            <a id="btnJoinTable" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/get-mtable']) ?>"><i class="ion ion-arrow-shrink" style="font-size: 16px; color: white"></i> Gabung Meja</a>
                            <a id="btnFreeMenu" class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['page/free-menu']) ?>"><i class="ion ion-bag" style="font-size: 16px; color: white"></i> Free Menu</a>
                        </div>                                                    
                    </div>
                        ...
                        <div class="white-panel pn" style="height: auto; color: #000">
                            ...
                            <div class="table-responsive">
                                        ...
                                        if (count($modelMtableOrders) > 0): 
                                            ...
                                            foreach ($modelMtableOrders as $mtableOrderData):                                             
                                                ...
                                                if ($mtableOrderData->discount_type == 'percent') {                                                    
                                                    ...
                                                    $totalDisc += $disc;
                                                } elseif ($mtableOrderData->discount_type == 'value') {
                                                    ...
                                                    <td id="menu" class="goleft">
                                                        ...
                                                        if (!empty($mtableOrderData->menuQueue)) {
                                                            ...
                                                            if ($mtableOrderData->menuQueue->is_finish)
                                                                $badgeMenuQueue = '<span class="badge bg-success"><i class="fa fa-thumbs-up" style="color:#000"></i></span>';
                                                            else
                                                                $badgeMenuQueue = '<span class="badge bg-important"><i class="fa fa-thumbs-o-up" style="color:#FFF"></i></span>';
                                                        } ?>
                                ...
                                <div class="goleft" style="margin: 10px">
                                    ...
                                    &nbsp; &nbsp;
                                    <?= Html::a('<i class="fa fa-undo" style="color: white"></i> Back', Yii::$app->urlManager->createUrl(['page/index']), ['class' => 'btn btn-danger']) ?>
                                </div>                                
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="green-panel pn" style="height: auto">
                            <div class="green-header">
                                <h5 style="margin-top: 10px">Menu Category</h5>                                
                            </div>
                            <div style="padding: 0px 10px 15px 10px;">
                                ...
                                foreach ($modelMenuCategory as $menuCategoryData): 
                                    if (count($menuCategoryData['menuCategories']) > 0): ?>
                                        ...
                                        <div class="btn-group btn-block">
                                            <button type="button" class="btn btn-danger btn-block dropdown-toggle" data-toggle="dropdown">
                                                <?= $menuCategoryData['nama_category'] ?> <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu scrollable-menu" role="menu" style="height: auto; max-height: 250px; overflow-x: hidden">
                                                <?php
                                                foreach ($menuCategoryData['menuCategories'] as $menuCategoryChildData): ?>
                                                
                                                    <li><a id="menu-category" href="<?= Yii::$app->urlManager->createUrl(['page/get-menu', 'id' => $menuCategoryChildData['id']]) ?>"><?= $menuCategoryChildData['nama_category'] ?></a></li>
                                    ...
                                    <?php
                                        ...
                                        <a id="menu-category" class="btn btn-danger btn-block" href="<?= Yii::$app->urlManager->createUrl(['page/get-menu', 'id' => $menuCategoryData['id']]); ?>"><?= $menuCategoryData['nama_category'] ?></a>
                        ...
                        <div class="col-md-8 col-sm-8">
                            <div class="input-group input-group-sm">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default btn-keyboard"><i class="fa fa-keyboard-o"></i></button>
                                </span>
                            </div>                     
                        </div>
                    </div>
...
echo $printerDialog->renderDialog('frontendpos');
...
$jscript = '            
    ...
    var catatanMenuModal = function(thisObj, oldValue, title, theFunction) {
        ...
        }).attr("class", "form-control keyboard").val(oldValue);

        var keyboard =  $("<button>").on("click", function(event) {
        ...
        .attr("class", "btn btn-default").append("<i class=\"fa fa-keyboard-o\"></i>");

        var span = $("<span>").attr("class", "input-group-btn").append(keyboard);
        var div = $("<div>").attr("class", "input-group input-group-sm").append(catatan).append(span);
        ...
        $("#modalCustom #modelCustomBody #content").html("").append(div).append(submit);
        $("#modalCustom").modal(); 
    };
        
    var loadMenu = function(thisObj) {
        $.ajax({
            cache: false,
            type: "POST",
    ...
    $("a#menu-category").on("click", function(event) {
        event.preventDefault();                
        loadMenu($(this));
    });

    loadMenu($("a#menu-category"));
    
    var openTable = function() {
        if ($("input#sessionMtable").length == 0) {
            var jmlTamu = $("<input>").keyboard({
                    openOn   : null,                        
                    layout   : "qwerty",
                    css: {
                        input: "form-control input-sm",
            ...
            }).attr("class", "form-control keyboard").val($("input#inputJumlahTamu").val());
            ...
            var span = $("<span>").attr("class", "input-group-btn").append(keyboard);
            var div = $("<div>").attr("class", "input-group input-group-sm").append(jmlTamu).append(span);

            var submit = $("<button>").on("click", function(event) {
                $("input#inputJumlahTamu").val($(this).parent().find("input").val());
                $("#modalCustom").modal("hide");
            ...
            $("#modalCustom #modalCustomTitle").text("Jumlah Tamu");
            $("#modalCustom #modelCustomBody #content").html("").append(div).append(submit);
            $("#modalCustom").modal();
        }
    };
    ...
    $("a#btnDiscount").on("click", function(event) {
        ...
        var discountFunction = function() {
            if ($("tbody#tbodyOrderMenu tr#menuRow").hasClass("highlight")) {
                var menu = "";

                $("tbody#tbodyOrderMenu tr#menuRow.highlight").each(function() {  
                    var thisRow = $(this);
    ...
    $("a#btnVoid").on("click", function(event) {
        ...
        var voidMenuFunction = function() {
            ...
            if ($("tbody#tbodyOrderMenu tr#menuRow").hasClass("highlight")) {
                ...
                catatanMenuModal($("tbody#tbodyOrderMenu tr#menuRow.highlight").find("input.inputMenuCatatan"), "", "Alasan Void", theFunction);
            } else {
                $("#modalAlert #modalAlertBody").html("Tidak ada yang dipilih");
                $("#modalAlert").modal();
            }
        ...
        var freeMenuFunction = function() {
            if ($("tbody#tbodyOrderMenu tr#menuRow").hasClass("highlight")) {                            
                ...
                $("#modalConfirmation #submitConfirmation").on("click", function() {
                    ...
                    catatanMenuModal($("tbody#tbodyOrderMenu tr#menuRow.highlight").find("input.inputMenuCatatan"), "", "Alasan Free Menu", theFunction);
    ...
    $("button#btnCloseTable").on("click", function(event) {
        ...
        if ($(document).find("input#sessionMtable").hasClass("sessionMtable")) {
                ...
                if (menu != "") {
                    ...
                    if (menu != "")
                        msg += "<b>" + menu + "</b><br>Tidak bisa melakukan close table karena data belum disave.<br>";
    ...
    $("button#btnCatatanMenu").on("click", function(event) {
        if ($("tbody#tbodyOrderMenu tr#menuRow").hasClass("highlight")) {
            var obj = $("tbody#tbodyOrderMenu tr#menuRow.highlight");                   
    ...
    $("button#btnPrintOrder").on("click", function(event) {        
        ...
        if ($("tbody#tbodyOrderMenu tr#menuRow").hasClass("highlight")) {
            if ($(document).find("input#sessionMtable").hasClass("sessionMtable")) {                        
                ...
                header += "Meja" + separatorPrint(14 - "Meja".length) + ": " + $("input#tableId").val() + "\n";
                header += "Tanggal/Jam" + separatorPrint(14 - "Tanggal/Jam".length) + ": " + $("input#tglJam").val() + "\n";
                header += "User" + separatorPrint(14 - "User".length) + ": " + $("input#userActive").val() + "\n";                                
                ...
                $("tbody#tbodyOrderMenu  tr#menuRow.highlight").each(function() {
                    if ($(this).find("input.inputId").length == 0) {
                        notSave += "(" + $(this).find("td#menu span").text() + ") ";  
                    } else {
                        var thisObj = $(this);
                        $(this).find("input.inputMenuCategoryPrinter").each(function() {
                            ...
                            var menu = thisObj.find("td#menu span").html();
                            var qty = thisObj.find("td#qty input.inputMenuQty").val();
                            var separatorLength = 40 - (menu.length + qty.length);                                        

                            content[printer] += menu + separatorPrint(separatorLength) + qty + "\n";

                            var catatan = thisObj.find("td#menu input.inputMenuCatatan").val();                                     
                ...
                if (notSave != "") {
                    $("#modalAlert #modalAlertBody").html("<b>" + notSave + "</b><br>Tidak bisa melakukan print order karena ada data yang belum disave");
                    $("#modalAlert").modal();
                } else {         
                    printContent(header, footer, content);                                        
                }
            } else {
                $("#modalAlert #modalAlertBody").html("Tidak bisa melakukan print order karena data belum disave");
                $("#modalAlert").modal();
            }
        } else {
            $("#modalAlert #modalAlertBody").html("Tidak ada yang dipilih");
    ...
    $("button#btnPrintInvoice").on("click", function(event) {
        if ($(document).find("input#sessionMtable").hasClass("sessionMtable")) {
            var text = "";
            var totalQty = 0;
            var totalSubtotal = 0;
            ...
            text += "User" + separatorPrint(14 - "User".length) + ": " + $("input#userActive").val() + "\n";
            ...
            var grandTotal = totalSubtotal + serviceCharge + pajak;
            ...
            text += sc + separatorPrint(40 - (sc + serviceChargeSpan.html()).length) + serviceChargeSpan.html() +"\n";
            text += pjk + separatorPrint(40 - (pjk + pajakSpan.html()).length) + pajakSpan.html() +"\n";
            ...
            var totalVoidSpan = $("<span>").html(totalVoid);
            totalVoidSpan.currency({' . Yii::$app->params['currencyOptionsPrint'] . '});
            text += "*Total Discount" + separatorPrint(40 - ("*Total Discount" + grandTotalSpan.html()).length) + grandTotalSpan.html() +"\n";
    ...
    $("button.btnQty").on("click", function(event) {
        var menu = "";
        var btnQty = $(this);
        $("tbody#tbodyOrderMenu tr#menuRow.highlight").find("input.inputMenuQty").each(function() {
    ...
    $("input.keyboardDisc, input.keyboardUserPass").keyboard({
        openOn   : null,                        
        layout   : "qwerty",
        css: {
            input: "form-control input-sm",
    ...
    $("button.btn-keyboard").on("click", function(event) {
        var kb = $(this).parent().parent().find("input.showKeyboard").getkeyboard();
        if ( kb.isOpen ) {
            kb.close();
        } else {
            kb.reveal();
