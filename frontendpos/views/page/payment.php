...
$jscript = '     
                ...
                if (value > 0) {                                        
                    if ($(this).attr("data-id") == "XLIMIT" || $(this).attr("data-id") == "XVCHR") {  
                        var openKeyboard = function() {
                            var kb = $(".keyboardKode").getkeyboard();
                            if (kb.isOpen) {
                                kb.close();
                            } else {
                                kb.reveal();
                        ...
                        }).attr("class", "form-control keyboardKode").focusin(function(event){
                            openKeyboard();
                        }).val("");
            ...
            $("form#formPayment").on("submit", function() {     
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data.flag) {
                                    ...
                                    text += "Faktur" + separatorPrint(14 - "Faktur".length) + ": " + data.noFaktur + "\n";
                                    ...
                                    printContent("", "", content, true, locationFunction);
                                } else {
                ...
                if ($("input#isKoreksi").val() == 1) {       
                    ...
                    }).attr("class", "form-control keyboard keterangan").focusin(function(event){
                        openKeyboard();
                    }).val("");
            ...
            var openKeyboard = function() {
                var kb = $("textarea.keyboard").getkeyboard();
                if (kb.isOpen) {
                    kb.close();
                } else {
                    kb.reveal();
